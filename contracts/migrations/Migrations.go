...
func (_Alastria *AlastriaCaller) LastCompletedMigration(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _Alastria.contract.Call(opts, &out, "last_completed_migration")
...
//
// Solidity: function last_completed_migration() view returns(uint256)
func (_Alastria *AlastriaSession) LastCompletedMigration() (*big.Int, error) {
	return _Alastria.Contract.LastCompletedMigration(&_Alastria.CallOpts)
}

// LastCompletedMigration is a free data retrieval call binding the contract method 0x445df0ac.
//
// Solidity: function last_completed_migration() view returns(uint256)
func (_Alastria *AlastriaCallerSession) LastCompletedMigration() (*big.Int, error) {
	return _Alastria.Contract.LastCompletedMigration(&_Alastria.CallOpts)
}
...
func (_Alastria *AlastriaTransactor) SetCompleted(opts *bind.TransactOpts, completed *big.Int) (*types.Transaction, error) {
	return _Alastria.contract.Transact(opts, "setCompleted", completed)
}

// SetCompleted is a paid mutator transaction binding the contract method 0xfdacd576.
//
// Solidity: function setCompleted(uint256 completed) returns()
func (_Alastria *AlastriaSession) SetCompleted(completed *big.Int) (*types.Transaction, error) {
	return _Alastria.Contract.SetCompleted(&_Alastria.TransactOpts, completed)
}

// SetCompleted is a paid mutator transaction binding the contract method 0xfdacd576.
//
// Solidity: function setCompleted(uint256 completed) returns()
func (_Alastria *AlastriaTransactorSession) SetCompleted(completed *big.Int) (*types.Transaction, error) {
	return _Alastria.Contract.SetCompleted(&_Alastria.TransactOpts, completed)
}
