...
var AlastriaContractsMetaData = &bind.MetaData{
	ABI: "[{\"constant\":true,\"inputs\":[],\"name\":\"last_completed_migration\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"completed\",\"type\":\"uint256\"}],\"name\":\"setCompleted\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
func (_AlastriaContracts *AlastriaContractsCaller) LastCompletedMigration(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _AlastriaContracts.contract.Call(opts, &out, "last_completed_migration")
...
//
// Solidity: function last_completed_migration() view returns(uint256)
func (_AlastriaContracts *AlastriaContractsSession) LastCompletedMigration() (*big.Int, error) {
	return _AlastriaContracts.Contract.LastCompletedMigration(&_AlastriaContracts.CallOpts)
}

// LastCompletedMigration is a free data retrieval call binding the contract method 0x445df0ac.
//
// Solidity: function last_completed_migration() view returns(uint256)
func (_AlastriaContracts *AlastriaContractsCallerSession) LastCompletedMigration() (*big.Int, error) {
	return _AlastriaContracts.Contract.LastCompletedMigration(&_AlastriaContracts.CallOpts)
}
...
func (_AlastriaContracts *AlastriaContractsTransactor) SetCompleted(opts *bind.TransactOpts, completed *big.Int) (*types.Transaction, error) {
	return _AlastriaContracts.contract.Transact(opts, "setCompleted", completed)
}

// SetCompleted is a paid mutator transaction binding the contract method 0xfdacd576.
//
// Solidity: function setCompleted(uint256 completed) returns()
func (_AlastriaContracts *AlastriaContractsSession) SetCompleted(completed *big.Int) (*types.Transaction, error) {
	return _AlastriaContracts.Contract.SetCompleted(&_AlastriaContracts.TransactOpts, completed)
}

// SetCompleted is a paid mutator transaction binding the contract method 0xfdacd576.
//
// Solidity: function setCompleted(uint256 completed) returns()
func (_AlastriaContracts *AlastriaContractsTransactorSession) SetCompleted(completed *big.Int) (*types.Transaction, error) {
	return _AlastriaContracts.Contract.SetCompleted(&_AlastriaContracts.TransactOpts, completed)
}
